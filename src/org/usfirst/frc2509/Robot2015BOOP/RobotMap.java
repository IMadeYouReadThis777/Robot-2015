...
LimitSwitch1 = new DigitalInput(0);
	LiveWindow.addSensor("LimitSwitch1", 0, LimitSwitch1);
	
LimitSwitch2 = new DigitalInput(1);
	LiveWindow.addSensor("LimitSwitch2", 1, LimitSwitch2);

LimitSwitch3 = new DigitalInput(2);
	LiveWindow.addSensor("LimitSwitch3", 2, LimitSwitch3);

LimitSwitch4 = new DigitalInput(3);
	LiveWindow.addSensor("LimitSwitch4", 3, LimitSwitch4);
