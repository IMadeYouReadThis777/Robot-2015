...
public class OI {
    ...
    public OI() {
        ...
        joystickButton5 = new JoystickButton(joystick2, 6);
        joystickButton5.whenPressed(new LiftUp());
        joystickButton2 = new JoystickButton(joystick2, 1);
        joystickButton2.whenPressed(new Guide_In());
        joystickButton4 = new JoystickButton(joystick2, 3);
        joystickButton4.whenPressed(new Grip_Out());
        joystick1 = new Joystick(0);
        
        joystickButton6 = new JoystickButton(joystick1, 6);
        joystickButton6.whenPressed(new LiftDown());
        joystickButton3 = new JoystickButton(joystick1, 3);
        joystickButton3.whenPressed(new Grip_In());
        joystickButton1 = new JoystickButton(joystick1, 1);
        joystickButton1.whenPressed(new Guide_Out());


        // SmartDashboard Buttons
        SmartDashboard.putData("Autonomous Command", new AutonomousCommand());
        SmartDashboard.putData("Guide_In", new Guide_In());
        SmartDashboard.putData("Guide_Out", new Guide_Out());
        SmartDashboard.putData("Grip_In", new Grip_In());
        SmartDashboard.putData("Grip_Out", new Grip_Out());
